...
public class page3 extends Fragment {
    ...
    public static YouTubePlayerView youTubePlayerView3 ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        youTubePlayerView3 = rootView.findViewById(R.id.youtube_player_view_3);
    ...
    private void fillYoutubeVideos(){
        ...
        //TODO: auto play
        youTubePlayerView3.getYouTubePlayerWhenReady(new YouTubePlayerCallback() {
            @Override
            public void onYouTubePlayer(@NonNull YouTubePlayer youTubePlayer) {
                youTubePlayer.cueVideo(searchResults3.get(0).getId(),0);
            }
        });
    }
