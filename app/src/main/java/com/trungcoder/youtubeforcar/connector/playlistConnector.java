...
public class playlistConnector {
    ...
    public playlistConnector(Context context,String _PLAYLISTID){
        ...
        try {
            ...
            request = request = youtubeService.playlistItems()
    ...
    private static List<VideoItem> setItemsList(Iterator<PlaylistItem> iteratorSearchResults) {
        ...
        while (iteratorSearchResults.hasNext()) {
            ...
            item.setId(singleVideo.getContentDetails().getVideoId());
